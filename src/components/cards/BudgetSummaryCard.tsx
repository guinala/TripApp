  ...
  return (
    <View style={styles.card}>
      <View style={styles.labelRow}>
        <Text style={styles.labelMeta}>TOTAL GASTADO</Text>
        <Text style={[styles.labelMeta, styles.percent]}>{Math.round(percentage)} %</Text>
      </View>

      <View style={styles.moneyRow}>
        <Text style={styles.amount}>{formatNumber(spent, currency)}</Text>
        <Text style={styles.amountSub}> € / {formatNumber(budget, currency)} €</Text>
      </View>
      ...
      <View style={styles.labelRow}>
        <Text style={styles.labelMeta}>
          {overBudget ? 'Excedido ' : 'Quedan '}
          <Text style={{ color: overBudget ? colors.primary : colors.accent }}>
            {formatCurrency(Math.abs(remaining), currency)}
          </Text>
        </Text>
        <Text style={styles.labelMeta}>
          Promedio diario: <Text style={styles.bold}>{formatCurrency(dailyAverage, currency)}</Text>
        </Text>
      </View>
    </View>
  );
